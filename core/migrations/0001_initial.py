# Generated by Django 4.2.11 on 2026-03-02 05:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assignment_type', models.CharField(choices=[('react', 'React'), ('sql', 'SQL'), ('python', 'Python'), ('html_css', 'HTML/CSS')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('grading', 'Grading'), ('completed', 'Completed')], default='pending', max_length=20)),
